...
public class CustomServerPaymentRequest extends SignedSerializableObject {
	 ...
	 */
	public CustomServerPaymentRequest(int version, PKIAlgorithm pkiAlgorithm, int keyNumber, ServerPaymentRequest serverPaymentRequest) throws ch.uzh.csg.mbps.customserialization.exceptions.IllegalArgumentException, NotSignedException{
