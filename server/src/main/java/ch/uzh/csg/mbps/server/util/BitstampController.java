...
public class BitstampController {
	...
	private static Exchange getExchange() {
		...
		exSpec.setUserName(SecurityConfig.BITSTAMP_USERNAME);
		exSpec.setApiKey(SecurityConfig.BITSTAMP_APIKEY);
		exSpec.setSecretKey(SecurityConfig.BITSTAMP_SECRETKEY);
