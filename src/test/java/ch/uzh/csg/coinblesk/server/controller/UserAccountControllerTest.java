...
public class UserAccountControllerTest {
    ...
    public void testCreateUserAccount() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(post("/user/create").secure(false).contentType(MediaType.APPLICATION_JSON).content(asString)).andExpect(status().isOk()).andReturn();
    ...
    public void testCreateUserAccount_EmptyFields() throws UsernameAlreadyExistsException, InvalidUsernameException, InvalidEmailException, EmailAlreadyExistsException,
            InvalidUrlException {
    ...
    public void testVerifyEmail() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(get("/user/verify/" + token).secure(false)).andExpect(status().isOk()).andReturn();

        mvcResult = mockMvc.perform(get("/user/verify/" + token).secure(false)).andExpect(status().isOk()).andExpect(view().name("FailedEmailVerification")).andReturn();

        HttpSession session = loginAndGetSession(test29.getUsername(), plainTextPassword);

        mvcResult = mockMvc.perform(get("/user/afterLogin").secure(false).session((MockHttpSession) session)).andExpect(status().isOk())
    ...
    public void testReadUserAccount() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(get("/user/afterLogin").secure(false).session((MockHttpSession) session)).andExpect(status().isOk())
                .andExpect(content().contentType(TestUtil.APPLICATION_JSON_UTF8)).andReturn();
    ...
    public void testUpdateUserAccount_FailNotAuthorized() throws Exception {
        ...
        mockMvc.perform(post("/user/update").secure(false).contentType(MediaType.APPLICATION_JSON).content(asString)).andExpect(status().isUnauthorized());
    }
    ...
    public void testUpdateUserAccount() throws Exception {
        ...
        mockMvc.perform(post("/user/update").secure(false).session((MockHttpSession) session).contentType(MediaType.APPLICATION_JSON).content(asString)).andExpect(status().isOk());
    ...
    public void testDeleteUserAccountFailNotAuthorized() throws Exception {
        mockMvc.perform(post("/user/update").secure(false).contentType(MediaType.APPLICATION_JSON)).andExpect(status().isUnauthorized());
    }
    ...
    public void testDeleteUserAccount() throws Exception {
        ...
        mockMvc.perform(get("/user/delete").secure(false).session((MockHttpSession) session).contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk());
        ...
        mvcResult = mockMvc.perform(get("/user/delete").secure(false).session((MockHttpSession) session).contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
                .andReturn();
    ...
    public void testResetPassword() throws Exception {
        ...
        result = mockMvc.perform(post("/user/resetPasswordRequest").secure(false).contentType(MediaType.APPLICATION_JSON).content(mappedString)).andExpect(status().isOk())
                .andReturn();
        ...
        mockMvc.perform(get("/user/resetPassword/" + token).secure(false)).andExpect(status().isOk()).andExpect(view().name("WrongToken"));

        HttpSession session = loginAndGetSession(test30.getUsername(), "test");

        MvcResult mvcResult3 = mockMvc.perform(get("/user/afterLogin").secure(false).session((MockHttpSession) session)).andExpect(status().isOk())
                .andExpect(content().contentType(TestUtil.APPLICATION_JSON_UTF8)).andReturn();
    ...
    public void testSaveUserPublicKey() throws Exception {
        ...
        MvcResult result = mockMvc
                .perform(post("/user/savePublicKey").secure(false).session((MockHttpSession) session).contentType(MediaType.APPLICATION_JSON).content(mappedString))
                .andExpect(status().isOk()).andReturn();
    ...
    public void testGetMainActivityRequests() throws Exception {
        ...
        userAccountService.saveUserPublicKey(test32.getId(), PKIAlgorithm.DEFAULT, KeyHandler.encodePublicKey(keyPairPayer.getPublic()));
        ...
        mvcResult = mockMvc.perform(get("/user/mainActivityRequests").secure(false).session((MockHttpSession) session)).andExpect(status().isOk()).andReturn();
        ...
        mvcResult = mockMvc.perform(get("/user/mainActivityRequests").secure(false).session((MockHttpSession) session)).andExpect(status().isUnauthorized()).andReturn();
    }
