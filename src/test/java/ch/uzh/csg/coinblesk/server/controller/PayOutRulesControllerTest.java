...
import ch.uzh.csg.coinblesk.server.controller.PayOutRulesController;
...
public class PayOutRulesControllerTest {
	...
	public void testTransform()  {
		...
		ch.uzh.csg.coinblesk.server.domain.PayOutRule por = new ch.uzh.csg.coinblesk.server.domain.PayOutRule();
		por.setBalanceLimit(BigDecimal.ONE);
		por.setDay(3);
		por.setHour(12);
		por.setPayoutAddress("msgc3DFzszXQx6F5nHi8xdcB2EheKYW7xW");
		por.setUserId(1);
		ch.uzh.csg.coinblesk.server.domain.PayOutRule por2 = new ch.uzh.csg.coinblesk.server.domain.PayOutRule();
		por.setBalanceLimit(BigDecimal.ONE);
		por.setDay(4);
		por.setHour(13);
		por.setPayoutAddress("msgc3DFzszXQx6F5nHi8xdcB2EheKYW7xW");
		por.setUserId(2);
		List<ch.uzh.csg.coinblesk.server.domain.PayOutRule> list = new ArrayList<ch.uzh.csg.coinblesk.server.domain.PayOutRule>();
		list.add(por);
		list.add(por2);
		PayOutRulesController controller = new PayOutRulesController();
		List<ch.uzh.csg.coinblesk.model.PayOutRule> list2 = controller.transform(list);
		ch.uzh.csg.coinblesk.model.PayOutRule por3 = list2.get(0);
		ch.uzh.csg.coinblesk.model.PayOutRule por4 = list2.get(1);
