...
public class PayOutRuleDAO {
	...
	private static PayOutRule transform(ch.uzh.csg.coinblesk.model.PayOutRule por) {
	 ...
	 */
	public void createPayOutRules(List<ch.uzh.csg.coinblesk.model.PayOutRule> list) {
		for(ch.uzh.csg.coinblesk.model.PayOutRule po:list) {
