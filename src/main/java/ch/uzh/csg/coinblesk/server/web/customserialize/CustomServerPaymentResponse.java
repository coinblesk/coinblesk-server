...
private static final int NOF_BYTES_FOR_PAYLOAD_LENGTH = 2; // 2 bytes for the payload length, up to 65536 bytes
	 ...
	 */
	public CustomServerPaymentResponse(int version, PKIAlgorithm pkiAlgorithm, int keyNumber, ServerPaymentResponse serverPaymentResponse) throws ch.uzh.csg.coinblesk.customserialization.exceptions.IllegalArgumentException, NotSignedException{
