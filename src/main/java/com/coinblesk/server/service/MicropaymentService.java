...
public class MicropaymentService {
	...
	public VirtualPaymentResult virtualPayment(@NonNull ECKey keySender, @NonNull ECKey keyReceiver, long amount, long
		...
		if (sender == null) throw new UserNotFoundException(keySender.getPublicKeyAsHex());
		...
		if (amount < 1) throw new InvalidAmountException("Invalid amount. Must be 1 or larger.");
		...
		if (receiver == null) throw new UserNotFoundException(keyReceiver.getPublicKeyAsHex());
